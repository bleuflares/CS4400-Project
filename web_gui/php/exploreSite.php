    ...
    <form class="form-signin">
        ...
        <div class="container">
            ...
            <div class="col-sm-0 offset-2">
                    <button class="btn btn-sm btn-primary btn-block col-sm-12" style= "width:150px" style="border-radius: 5px;">Filter</button>
                </div>

                <div class="col-sm-0 offset-2" style="text-align: right;">
                    <input id ="button" class="btn btn-sm btn-primary btn-block col-sm-0"  type="submit" name="button" onclick="filter();" value="Site Detail"/>
                ...
                <div class="col-sm-0 offset-1">
                    <input id ="button" class="btn btn-sm btn-primary btn-block col-sm-0 offset-6"  type="submit" name="button" onclick="myFunction();" value="Transit Detail"/>
                </div>
